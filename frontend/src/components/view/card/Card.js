    ...
    */
    return (
        <div
            ...
            <div className="grid-individual-card card-background-yellow">
                ...
                <div className="attack-description">
                    <span className="attack-name">Thundershock</span> Flip a
                    coin. If tails, Pikachu does 10 damage to itself.
                </div>
                <div className="attack-damage">10</div>
                ...
                <div className="copyright">
                    <strong>Illus. Mitsuhiro Arita</strong> ©1995, 96, 98
                    Nintendo Creatures, GAMEFREAK ©1999 Wizards.{' '}
                    <strong>58/102 ●</strong>
                </div>
            </div>
        </div>
    )
